...
全圈查看位置：0.00, 0.07, 0.14, 0.21, 0.28, 0.31, 0.335, 0.36, 0.43, 0.50, 0.57, 0.62, 0.64, 0.67, 0.71, 0.78, 0.85, 0.92, 0.97。森林密度較高的 0.67–0.92 也已檢查。美術仍為風格化分枝團塊，山體輪廓仍有低多邊形折面；不宣稱照片級寫實。靜態巡查不能證明高速時完全沒有 LOD pop，硬體上仍須確認轉換流暢度、陰影穩定度與幀時間。
