...
import { sampleTrack, TRACK_WIDTH } from "./track.mjs";
...
export function roadDistance(track, x, z) {
...
export function createVerge(track, side) {
...
export function createMountain(seed, width, height, depth, detail) {
